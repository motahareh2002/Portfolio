    ...
    <div class="bg-[#0b0b0f] h-fit">
        <div class="relative">
            ...
            <div class="absolute top-0">
                ...
                <!-- banner -->
                <div
                    class="md:mt-32 lg:mt-44 xl:mt-56 flex flex-col items-center"
                >
                    <p
                    ...
                    >
                        Elevate your online presence while earning loyalty coins
                        with GeeG.Me . Simplify your links, amplify your reach,
                ...
                >
                    ...
                    >
                        ...
                        >
                        <p
                            class="text-[#898CA9] md:text-[11px] lg:text-[16px] mt-2"
                        >
                            Gather all your essential links in one convenient
                            location.
                        </p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <p
                            class="text-[#898CA9] md:text-[11px] lg:text-[16px] mt-2"
                        >
                            Personalize your page to reflect your unique brand
                            identity.
                        </p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <p
                            class="text-[#898CA9] md:text-[11px] lg:text-[16px] mt-2"
                        >
                            Engage with the platform and earn loyalty coins for
                            each interaction
                        </p>
                    </div>
                </div>
                    ...
                    <div class="ml-10 lg:-ml-20">
                        ...
                        >
                            <swiper-slide v-for="i in 5" :key="i"
                                ><div
                                    class="flex flex-col items-start lg:ml-32"
                                >
                                    <span
                                    ...
                                    >
                                    <p
                                        class="text-[#898CA9] md:text-[10px] lg:text-[16px]"
                                    >
                                        Sign up and set up your personalized
                                        link hub effortlessly
                                    </p>
                                    <button
                        ...
                        <div class="my-5 flex justify-end items-center">
                            ...
                            <div
                                class="flex items-center relative z-10 w-fit bottom-[45px]"
                            >
                                <div class="mr-5">
                                    <button
        ...
        <div class="relative">
            ...
            >
                ...
                >
                    Join our pioneering social media platform where followers
                    and influencers securely communicate, exchanging ideas and
                    tasks, seizing the opportunity to earn cryptocurrency
            ...
            >
                <div class="">
                    ...
                    >
                        Enter the world of safe, secure cryptocurrency
                        adventures
                    </p>
                    <p
                        class="text-[#898CA9] md:text-[12px] lg:text-[16px] w-10/12 lg:w-7/12"
                    >
                        with our platform's coin, essential for our task-based
                        economy, while boosting our customers' businesses.
                    </p>
                    <button
                        style="
                            background: linear-gradient(
